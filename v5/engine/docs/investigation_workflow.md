...
> **维护目录**：`v4/`（独立可运行包）。根目录说明见 `v4/README.md`、`v4/MANIFEST.md`。
...
`WorkflowRouter` (`workflow/workflow_router.py`) loads rules from `v1/workflow_config/configs/*.yaml` via `WorkflowConfigLoader`:
