...
const nav = [
  { href: "/executive", label: "Executive Intelligence", icon: Sparkles },
  { href: "/dashboard", label: "Dashboard", icon: LayoutDashboard },
  { href: "/investigation", label: "Investigation Workspace", icon: Activity },
  { href: "/investigation/new", label: "New Investigation (Goal)", icon: PlusCircle },
];
    ...
    <aside className="flex h-screen w-60 flex-col bg-sidebar text-sidebar-foreground border-r border-sidebar-border">
      <div className="flex items-center gap-2 px-5 py-6 border-b border-sidebar-border">
        ...
        <div>
          ...
          <p className="text-xs text-sidebar-muted">Risk Intelligence v5</p>
        </div>
      </div>
      ...
      <div className="border-t border-sidebar-border px-5 py-4 text-xs text-sidebar-muted">
        ...
        <div className="mt-1 flex items-center gap-2">
          ...
          monitor → trend → contribution → report
        </div>
      </div>
    </aside>
  );
